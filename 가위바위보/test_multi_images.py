...
image_files = [f for f in os.listdir('imgs\\') if f.lower().endswith(valid_extensions)]
# imgs 폴더 내의 파일 중에서 .jpg 확장자로 끝나는 파일만 리스트에 저장
...
for file_name in image_files:
    # 이미지 불러오기
    image = Image.open(f'imgs\\{file_name}').convert("RGB")
